...
- **[Built Using ES6 Syntax & Modules]**
...
- [Awesome Books Library](https://sunga12.github.io/ES6-Awesome-Books/)
...
1. Download the zip file or clone with this command `git clone https://github.com/sunga12/ES6-Awesome-Books.git`(Make sure you have `Git installed` in your Computer or Install it by following [these steps](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git))
2. `Awesome-Books`
